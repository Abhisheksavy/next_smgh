                                        ...
                                        {isDocumentUpload ? (
                                             ...
                                             <>
                                                  {!f.value ? (
                                                       ...
                                                       <label className="relative border p-3 flex items-center justify-center cursor-pointer transition hover:bg-gray-50 bg-primary/4 py-8.5 border-primary rounded-xl border-dashed">
                                                            <span className="text-gray-400 flex flex-col justify-center items-center">
                                                                 <span className="mb-2 text-black/40">Upload Resume / CV</span>
                                                       ...
                                                       // File selected UI
                                                       <div className="flex items-center justify-between border bg-primary/4 p-3 rounded-xl">
                              ...
                              return (
                                   <>
                                        ...
                                        {/* <Controller
                                             ...
                                             render={({ field }) => (
                                                  <DatePickerInput 
                                                       value={(f.value as Date) || new Date()}
                         ...
                         <div className="grid md:grid-cols-2 gap-6">
                              {Object.entries(currentStep)
                                   ...
                                   .map(([fieldKey, field]: [string, any]) => (
                                        ...
                                        >
                                             <label className="text-foreground text-sm font-regular mb-2 block">
                                                  {field.label}
                                                  {/* {field.required && (
