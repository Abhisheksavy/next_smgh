                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {content.cards.map((card: any, index: number) => (
                        ...
                        >
                            ...
                            <Link
                                href="#"
                                className="text-secondary text-sm font-medium inline-flex items-center gap-2 hover:text-primary transition-colors"
                            >
                                ...
                                <div className="space-y-2 text-sm">
                                    {slot.morning && (
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">{slot.morning}</span>
                                        </div>
                                    )}
                                    {slot.afternoon && (
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Afternoon:</span>
                                            <span className="font-medium">{slot.afternoon}</span>
                                        </div>
                                    )}
                                    {slot.evening && (
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">Evening:</span>
                                            <span className="font-medium">{slot.evening}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
            ...
            <div className="space-y-12">
                ...
                {content.admission && (
                    <div className="space-y-6">
                        <h2 className="commonTitle">{content.admission.title}</h2>
                ...
                {content.dischargeBilling && (
                    <div className="space-y-6">
                        <h2 className="commonTitle">{content.dischargeBilling.title}</h2>
