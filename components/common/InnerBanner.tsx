...
const InnerBanner = ({ data }: { data: any }) => {
  return (
    <section
      className="innerBanner min-h-50 bg-cover bg-no-repeat bg-center relative overflow-hidden 
          before:content-[''] before:absolute before:inset-0 before:bg-white  before:opacity-50  before:z-0
          after:content-[''] after:absolute after:inset-0 after:bg-[linear-gradient(268.24deg,rgba(229,228,232,0.8)_20.47%,rgba(235,234,239,0)_39.27%)] after:z-1 after:rotate-180"
