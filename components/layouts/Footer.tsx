...
import ChatIcon from "@/icons/home-icons/clock-icon copy";
import { useGetFooterData } from "@/queries/useLayout";
import {
     Facebook,
     Twitter,
     Linkedin,
                    ...
                    <div className="max-w-[1400px] mx-auto">
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-16">
                              ...
                              <div className="space-y-4 lg:pr-4">
                                   <Image
                                        src={
                                             (footer?.logo as any).src ??
                                             (footer?.logo as any).url ??
                                             (footer?.logo as any).image?.src ??
                                             ""
                                        }
                                        alt="Footer Logo"
                                        width={120}
                         ...
                         <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-sm">
                              ...
                              <div className="flex items-center gap-3">
                                   {footer?.socialMedia.map((social: any) => {
                                        ...
                                        return (
                                             <Link
                                                  ...
                                                  className="w-9 h-9 rounded-full bg-tealgreen hover:bg-[#3AA5BA] flex items-center justify-center transition-colors"
                         ...
                         <div className="text-center mt-8">
                              <Link
                                   href={footer?.accessibility.href}
                              ...
                              >
                                   ...
                                   <span>{footer?.accessibility.label}</span>
                              </Link>
                         </div>
                    </div>
               </footer>
