...
const MissionVision = ({ mission }: any) => {
                              ...
                              return (
                                   <div key={index} className="col-span-4 bg-primary/4 px-8 pt-8">
                                        ...
                                        <div className="flex justify-end">
                                             <Image width="400" height="400" src={data?.backgroundImage} alt="" className="max-w-65 w-full h-auto opacity-4" />
                              ...
                              <div className="col-span-8  bg-primary/4 px-8 pt-8">
                                   <div className="grid grid-cols-12 gap-3">
                                        <div className="col-span-6 flex flex-col justify-between">
                                             <h2 className="text-2xl font-normal! commonTitle">  {mission?.vision?.[2]?.content} </h2>
                                             <div className=" -ml-8">
                                        ...
                                        <div className="col-span-6 flex flex-col gap-y-6 pb-8">
                                             {mission.vision?.[3] && (
                                                  mission.vision?.[3].info?.map((list: any, index: number) => {
                                                       return (

                                                            <div key={index} className="flex gap-x-3 ">
                                                                 <CircleCheck className=" flex-[0_0_auto]  w-4 text-secondary mt-0.5" />
                                                                 <div className="flex-1">
                                                                      <h3 className="text-lg font-medium text-secondary">   <span> {list?.heading}</span>
                                                                      </h3>
